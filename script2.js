...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (savedPoster) {
        document.getElementById('poster').src = savedPoster;
    }
    inputPoster = document.getElementById('poster10');
...
function saveState() {
    ...
    localStorage.setItem('poster', document.getElementById('poster').src)
